...
class MT_Customize_Selectize_Control extends WP_Customize_Control {

	public function enqueue() {
		wp_enqueue_style( ANTREAS_SLUG . '-selectize-style' );
		wp_enqueue_script( ANTREAS_SLUG . '-selectize-control', ANTREAS_ASSETS_JS . '/customizer-controls/selectize-control.js', array( 'jquery', 'customize-controls', ANTREAS_SLUG . '-selectize-script' ), false, true );
	}
