...
class MT_Customize_TinyMCE_Control extends WP_Customize_Control {

	public function enqueue() {
		wp_enqueue_script( ANTREAS_SLUG . '-tinymce-control', ANTREAS_ASSETS_JS . 'customizer-controls/tinymce-control.js', array( 'jquery', 'customize-controls' ), ANTREAS_VERSION );
	}
