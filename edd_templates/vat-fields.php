	...
	<div id="edd_vat_info" style="display: <?php echo $vat_fields['requires_vat'] ? "block" : "none"; ?>" >
		...
		<fieldset id="edd_vat_fields" class="vat_info" style="<?php echo $vat_fields['fields_style']; ?>">
			...
			<p id="edd-card-country-wrap">
				...
				<select name="billing_country" id="billing_country" data-nonce="<?php echo wp_create_nonce( 'edd-country-field-nonce' ); ?>" class="billing_country edd-select<?php if( edd_field_is_required( 'billing_country' ) ) { echo ' required'; } ?>">
					<?php
