...
<?php get_template_part( 'template-parts/sections/feature-1' ); ?>
<?php get_template_part( 'template-parts/sections/feature-2' ); ?>
<?php get_template_part( 'template-parts/sections/feature-3' ); ?>
