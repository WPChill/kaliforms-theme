...
const settings = {
		...
		from: [
			{
				...
				transform: ( { content } ) => createBlock( `machothemes/${ name }`, {
					content: content,
				} ),
			},
			{
	...
	save( { attributes } ) {
		...
		const textClasses = classnames( 'wp-block-machothemes-click-to-tweet__text', {
		...
		const buttonClasses = classnames( 'wp-block-machothemes-click-to-tweet__twitter-btn', {
